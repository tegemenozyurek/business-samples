  ...
  return (
    <div>
      ...
      <p className="mt-2 text-sm text-[var(--muted)]">
        Kartlardan birini seçerek başlayın.
      </p>
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2">
        {appointmentServices.map((service, index) => {
          ...
          return (
            <FadeUp key={service.id} delay={index * 0.03}>
              <button
                type="button"
                ...
                className={`group flex w-full overflow-hidden rounded-[1.25rem] border text-left transition-all duration-300 ${
                  selected
                    ...
                    : "border-[rgba(26,22,20,0.08)] bg-white hover:-translate-y-0.5 hover:border-[rgba(26,22,20,0.16)]"
                }`}
              >
